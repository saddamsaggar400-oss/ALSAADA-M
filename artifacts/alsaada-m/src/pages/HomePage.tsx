    ...
    <div className="min-h-screen bg-gray-200" dir="rtl">
      <div className="mx-auto min-h-screen w-full max-w-md bg-white relative overflow-x-hidden sm:shadow-xl">
        ...
        <section className="bg-white pb-6 pt-4 px-6 text-center">
          ...
          <button onClick={() => setLocation("/register")} className="text-xl font-bold text-[#101828] hover:text-[#0c6e3e] transition-colors cursor-pointer underline-offset-2 hover:underline">
            مربوطة بعدد الأبناء
          </button>
        </section>
        ...
        <section className="bg-white px-5 pb-6 pt-2">
          <div className="flex flex-col gap-3">
            {ctaButtons.map((label, i) => (
              <button key={i} onClick={() => setLocation("/register")} className="w-full py-4 text-lg font-bold rounded-2xl text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98]" style={greenGradient}>
                {label}
              </button>
            ))}
          </div>
          ...
          <div className="relative bg-gray-900 py-8 px-5">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center">
                <button onClick={() => setLocation("/register")} className="px-10 py-3 text-base font-bold rounded-2xl text-white transition-all duration-300 hover:scale-105 hover:shadow-xl" style={greenGradient}>
                  اشترك الآن واستمتع!
                </button>
              </div>
            </div>
